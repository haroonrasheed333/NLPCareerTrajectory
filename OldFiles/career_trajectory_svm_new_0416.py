...
if __name__ == '__main__':
    ...
    words = []
    bigrams_list = []
    print "Extract unigrams and bigrams"
    ...
    print "Select top unigrams and bigrams"
    fd = FreqDist(words)
    ...
    train_counts = vectorize(count_vect, train_featureset)
